...
#                  total_transitions: int = 100 * 1000,  # max trans per actor = total_transitions // num_actors
...
#             episodes of testing
#         checkpoint_interval: int
#             interval of updating the common for self-play
#         target_model_interval: int
#             interval of updating the target common for reanalyzing
#         save_ckpt_interval: int
#             interval of saving common
#         log_interval: int
#             interval of logging
#         vis_interval: int
